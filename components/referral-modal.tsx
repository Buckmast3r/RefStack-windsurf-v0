  ...
  useEffect(() => {
    if (referral) {
      setFormData({
        ...
        includeInPublicStack: referral.includeInPublicStack ?? true,
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <Label htmlFor="publicStack" className="cursor-pointer">
                Include in Public Stack
              </Label>
              <p className="text-xs text-blue-300/70">Show this referral on your public profile</p>
            </div>
            <Checkbox
              id="publicStack"
              checked={formData.includeInPublicStack}
              onCheckedChange={handlePublicStackChange}
